...
const WednesdaySermonsPage = () => {
  // Using the same structure as Sunday sermons for consistency
  const sermons = [
    { id: 1, title: '욥기 강해', speaker: '이영희 부목사', date: '2025-08-06', videoId: 'dQw4w9WgXcQ', image: '/images/sermon-wed1.jpg' },
    { id: 2, title: '욥기 강해', speaker: '이영희 부목사', date: '2025-07-30', videoId: 'dQw4w9WgXcQ', image: '/images/sermon-wed2.jpg' },
  ]
    ...
    <Layout>
      <div className="relative h-64 bg-black">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <h1 className="text-4xl font-bold text-white font-korean">수요예배</h1>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-12">
            {sermons.map((sermon) => (
              <div key={sermon.id} className="group">
                <Link href={`/sermons/wednesday/${sermon.id}`}>
