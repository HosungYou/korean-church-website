// ===========================================
// VS Design Diverge: Youth Ministry Page
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div>
                ...
                <p className="font-medium" style={{ color: 'oklch(0.30 0.09 265)' }}>중고등부실 (비전센터 2층)</p>
              </div>
              <div>
                <span className="text-xs font-medium tracking-[0.15em] uppercase block mb-2" style={{ color: 'oklch(0.72 0.10 75)' }}>
                  대상
                </span>
                <p className="font-medium" style={{ color: 'oklch(0.30 0.09 265)' }}>14-19세 청소년</p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-12">
            ...
            >
              ...
              <ul className="mt-6 space-y-3">
                {['역동적인 찬양 예배', '깊이 있는 말씀 나눔', '소그룹 교제', '청소년 리더십 훈련', '여름/겨울 수련회'].map((item, idx) => (
