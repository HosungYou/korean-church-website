// ===========================================
// VS Design Diverge: Infants Ministry Page
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div>
                ...
                <p className="font-medium" style={{ color: 'oklch(0.30 0.09 265)' }}>영아부실 (본관 1층)</p>
              </div>
              <div>
                <span className="text-xs font-medium tracking-[0.15em] uppercase block mb-2" style={{ color: 'oklch(0.72 0.10 75)' }}>
                  대상
                </span>
                <p className="font-medium" style={{ color: 'oklch(0.30 0.09 265)' }}>0-3세 아기와 부모님</p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-12">
            ...
            >
              ...
              <ul className="mt-6 space-y-3">
                {['찬양과 율동', '성경 이야기', '오감 활동', '부모님과 함께하는 예배'].map((item, idx) => (
