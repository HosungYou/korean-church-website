// ===========================================
// VS Design Diverge: Relief Missions Page
  ...
  return (
    <Layout>
      <PageHeader
        ...
        subtitle={isKorean
          ? '어려운 이웃을 돌보고 섬기는 그리스도의 사랑을 실천합니다'
          : 'Practicing the love of Christ by caring for and serving those in need'
        }
      />
      ...
      <section style={{ background: 'oklch(0.97 0.005 75)' }}>
        <div className="max-w-3xl mx-auto py-32 px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <Heart className="w-10 h-10" style={{ color: 'oklch(0.98 0.003 75)' }} />
          </div>
          ...
          <p className="leading-relaxed mb-4" style={{ color: 'oklch(0.55 0.01 75)', fontSize: '1.125rem' }}>
            {isKorean
              ? '구제선교 페이지가 곧 새롭게 준비됩니다.'
              : 'The Relief Missions page is being prepared and will be available soon.'}
          </p>
