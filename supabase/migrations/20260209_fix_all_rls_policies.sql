...
-- Safety: All table operations are wrapped in existence checks to prevent errors on missing tables
...
IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'sermons') THEN
  ...
  RAISE NOTICE 'sermons: attachment columns added successfully';
ELSE
